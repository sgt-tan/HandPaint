...
class DrawFrame:
	...
	def draw_final(self, frame, hand_detection): #paper detection param removed
		...
		if contours is not None and len(contours) > 0:
			...
			if centroid is not None and defects is not None and len(defects) > 0:	
				...
				num_defects = image_analysis.count_defects(defects, max_contour)
		...
		#return frame_final
		return num_defects,farthest_point,frame
